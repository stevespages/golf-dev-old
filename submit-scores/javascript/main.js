...
playerTables.forEach(function(playerTable){
    ...
    console.log(playerTableScores);
});
/*
holeInput.offsetParent.nextSibling.innerHTML
    = calculatePoints(score, holeNumber, holePar, holeSi, handicap);
const pointsTds = holeInput.offsetParent.offsetParent.parentNode.querySelectorAll('.points-td');
let totalPoints = 0;
